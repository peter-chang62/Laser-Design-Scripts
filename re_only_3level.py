...
ax.plot(z, e_p_z * f_r, label="signal", linewidth=2)
ax.plot(z, Pp, label="pump", linewidth=2)
ax.grid()
ax.legend(loc="best")
ax_2 = ax.twinx()
ax_2.plot(z, n2_n, color="C2", linestyle="--", linewidth=2)
ax_2.set_ylabel("relative population inversion")
...
ax2.set_ylabel("relative population inversion")
ax.set_ylabel("power (W)")
ax.set_xlabel("position (m)")
